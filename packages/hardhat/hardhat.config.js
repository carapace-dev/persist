...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      url: `https://mainnet.infura.io/v3/${process.env.MAINNET_INFURA_KEY}`, // <---- YOUR INFURA ID! (or it won't work)
    ...
    polygon: {
      ...
      gasPrice: mainnetPolygonGwei * 1000000000,
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    mumbai: {
      url: `https://polygon-mumbai.g.alchemy.com/v2/${process.env.POLYMUMBAI_ALCHEMY_KEY}`,
      // gasPrice: 1000000000,
      accounts: {
        mnemonic: mnemonic(),
      },
    ...
    goerliArbitrum: {
      ...
      url: `https://arb-goerli.g.alchemy.com/v2/${process.env.ARB_GOERLI_ALCHEMY_KEY}`,
      // gasPrice: 0,
      accounts: {
        mnemonic: mnemonic(),
      },
    ...
    arbitrum: {
      // url: "https://rinkeby.arbitrum.io/rpc",
      url: `https://arb-mainnet.g.alchemy.com/v2/${process.env.ARBITRUM_ALCHEMY_KEY}`,
      // gasPrice: 0,
      accounts: {
        mnemonic: mnemonic(),
      },
...
task("fundedwallet", "Create a wallet (pk) link and fund it with deployer?")
  ...
  .setAction(async (taskArgs, { network, ethers }) => {
    ...
    const amount = taskArgs.amount ? taskArgs.amount : "0.000000001";
    const tx = {
